...
<meta charset="UTF-8" />
<title>Message form (warnings)</title>
...
<body>
  <section>
    <div class="warnings">The data ware typed by You are not valid. Please, fill required fields * and other data like in placeholders.</div>
    <form action="/aprimindTask/controllers/formController.php" method="POST">
      <div class="inputgroup_container">
        <ul class="left">
          ...
          <li>
            ...
            <input type="text" name="company" tabindex="3" />
          </li>
          <li>
            <label for="email">Email*</label>
            <input type="text" name="email" tabindex="5" placeholder="signs@signs.signs" />
          </li>
        </ul>
        <ul class="right">
          <li>
          ...
          <li>
            ...
            <input type="text" name="phone" placeholder="+38(050)759-20-16" tabindex="4" />
          </li>
          <li>
            <label for="job_title">Job title</label>
            <input type="text" name="job_title" tabindex="6" />
          </li>
        </ul>
        </div>
        <div class="textarea_cont">
          <label for="message">Message</label>
          <textarea name="message" tabindex="8"></textarea>
